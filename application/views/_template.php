...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="#">Ci Panel</a></h1>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="#">Ci Panel</a> <div class="breadcrumb_divider"></div> <a class="current">Dashboard</a></article>
		</div>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Media</h3>
		<ul class="toggle">
			<li class="icn_folder"><a href="#">Crear Nuevo Album</a></li>
	...
	<section id="main" class="column">
		...
		<?php $this->load->view("admin_gestor"); ?>
