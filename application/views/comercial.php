...
<script src="<?php echo base_url()?>assets/js/scripts/jquery.easing.1.3.js" type="text/javascript"></script>

<script src="<?php echo base_url()?>assets/js/scripts/jquery.mousewheel.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/js/scripts/pop-ups.js"></script>
...
<nav>
  <ul id="menu" class="menu">
    <li> <a href="#" id="about"> <img src="<?php echo base_url()?>images/1_menu.jpg" alt=""/> <span class="active"></span> <span class="wrap"> <span class="link">Conocenos</span> <span class="descr">Conocenos</span> </span> </a> </li>
    <li> <a href="#" id="projects"> <img src="<?php echo base_url()?>images/2_menu.jpg" alt=""/> <span class="active"></span> <span class="wrap"> <span class="link">Ingresa</span> <span class="descr">Tu Codigo</span> </span> </a> </li>
    <li> <a href="#" id="contact"> <img src="<?php echo base_url()?>images/3_menu.jpg" alt=""/> <span class="active"></span> <span class="wrap"> <span class="link">Contacto</span> <span class="descr">Solo un Toque</span> </span> </a> </li>
    <!--<li > <a href="#" id="blog"> <img src="<?php echo base_url()?><a href=""></a>images/1_menu.jpg" alt=""/> <span class="active"></span> <span class="wrap"> <span class="link">Blog</span> <span class="descr">Daily musings</span> </span> </a> </li>-->
  </ul>
</nav>
<section id="bg">
  ...
  <div class="customScrollBox">
    <div class="container">
      <div class="content"> <a id="popupContactClose"><img src="images/cross.png" width="20" alt="" /></a>
        ...
        <br />
        <iframe width="425"
         height="300" class="map" src="http://maps.google.com/maps?hl=en&amp;q=701+first+ave+sunnyvale+ca&amp;ie=UTF8&amp;hq=&amp;hnear=701+1st+Ave,+Sunnyvale,+California+94089&amp;z=14&amp;ll=37.416883,-122.026022&amp;output=embed"></iframe>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/js/scripts/gallery.js"></script> 
<script type="text/javascript" src="<?php echo base_url()?>assets/js/scripts/jquery.mCustomScrollbar.js"></script>
</body>
</html>